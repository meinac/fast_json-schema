...
VALUE id_str, ref_str, recursiveAnchor_str, recursiveRef_str;

VALUE type_str, const_str, enum_str;

VALUE if_str, then_str, else_str, allOf_str, anyOf_str, oneOf_str, not_str;

// Integer and Number keywords
VALUE multipleOf_str, maximum_str, exclusiveMaximum_str, minimum_str, exclusiveMinimum_str;
